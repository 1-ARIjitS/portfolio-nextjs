                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <motion.a
                      ...
                      className="p-3 bg-background hover:bg-primary text-muted-foreground hover:text-primary-foreground rounded-lg transition-all duration-200 hover:scale-110"
